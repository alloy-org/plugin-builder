...
import { CODE_HEADING, CONSTANT_OBJECT, DEFAULT_BRANCH, MAX_REPLACE_CONTENT_LENGTH, ENTRY_LOCATIONS } from "./plugin-constants"
...
//    expect(noteContent).toContain(`// I will stay on line, promises ${ CONSTANT_OBJECT.replace(/\n/g, " ").replace(/\s{2,10000}/g, " ") }`)
